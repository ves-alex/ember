...
export const TRIGGER_TIPS = {
  stress: "Avant d'allumer : 5 respirations lentes, expiration deux fois plus longue que l'inspiration. L'envie retombe en ~3 min.",
  anxiete: "Nomme ce qui t'angoisse à voix haute ou par écrit. La clope masque l'anxiété, elle ne la règle pas.",
  ennui: "L'ennui passe vite : occupe tes mains 3 min (eau, marche, message à quelqu'un) avant de décider.",
  frustration: "Évacue par le corps, pas par la fumée : serre les poings 10 s puis relâche, ou sors marcher.",
  tristesse: "Sois doux avec toi. Un appel ou un vrai moment de réconfort fait plus qu'une clope.",
  joie: "Tu peux célébrer autrement : associe ce moment à autre chose pour ne pas le lier à la cigarette.",
  cafe: "C'est l'association café→clope, pas le manque. Change de main, de lieu, ou passe au thé quelques jours.",
  ...
  pause: "Garde la pause, change le rituel : marche, étirements ou eau au lieu de la clope. C'est la pause que tu veux, pas la nicotine.",
  reveil: "La première est la plus ancrée. Décale-la : douche, eau, petit-déj d'abord, clope repoussée d'autant.",
  soiree: "Repère le moment déclencheur (sortie fumeurs, terrasse) et prépare ta réponse avant d'y être.",
  conduite: "Mains occupées autrement : chewing-gum, playlist, fenêtre entrouverte. Bannis le paquet de la voiture.",
  attente: "L'attente est courte : sors le téléphone, un livre, ou respire — tu n'allumes pas par besoin mais par vide.",
  social: "« Non merci, j'arrête » suffit. Reste dans le groupe sans suivre dehors : tu verras que ça passe.",
